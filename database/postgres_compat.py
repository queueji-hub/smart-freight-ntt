...
def ensure_phase30_bl_schema(conn) -> None:
    ...
    with conn.cursor() as cur:
        ...
        columns = {
            ...
            "handling_info": "TEXT",
            "sci": "TEXT",
            "chargeable_weight": "NUMERIC(15,3) DEFAULT 0",
            "rate_class": "TEXT DEFAULT 'Q'",
            "commodity_item_no": "TEXT",
            "rate_charge": "NUMERIC(15,2) DEFAULT 0",
            "total_charge": "NUMERIC(15,2) DEFAULT 0",
            "weight_charge_ppd": "NUMERIC(15,2) DEFAULT 0",
            "weight_charge_coll": "NUMERIC(15,2) DEFAULT 0",
            "valuation_charge_ppd": "NUMERIC(15,2) DEFAULT 0",
            "valuation_charge_coll": "NUMERIC(15,2) DEFAULT 0",
            "tax_ppd": "NUMERIC(15,2) DEFAULT 0",
            "tax_coll": "NUMERIC(15,2) DEFAULT 0",
            "other_charges_agent_ppd": "NUMERIC(15,2) DEFAULT 0",
            "other_charges_agent_coll": "NUMERIC(15,2) DEFAULT 0",
            "other_charges_carrier_ppd": "NUMERIC(15,2) DEFAULT 0",
            "other_charges_carrier_coll": "NUMERIC(15,2) DEFAULT 0",
            "other_charges_desc": "TEXT",
            "total_prepaid": "NUMERIC(15,2) DEFAULT 0",
            "total_collect": "NUMERIC(15,2) DEFAULT 0",
            ...
            "origin": "TEXT",
            "destination": "TEXT",
            "volumetric_weight": "NUMERIC(15,3) DEFAULT 0",
            "dimension": "TEXT",
            "invoice_details": "TEXT",
            "customer_ref_no": "TEXT",
            "move_type": "TEXT DEFAULT 'Full Truck Load (FTL)'",
            "freight_charges": "NUMERIC(15,2) DEFAULT 0",
            "duty_other_charges": "NUMERIC(15,2) DEFAULT 0",
            "origin_charges": "NUMERIC(15,2) DEFAULT 0",
            "destination_charges": "NUMERIC(15,2) DEFAULT 0",
            "created_by": "TEXT",
            "created_at": "TIMESTAMP DEFAULT CURRENT_TIMESTAMP",
            "updated_at": "TIMESTAMP DEFAULT CURRENT_TIMESTAMP",
        }
