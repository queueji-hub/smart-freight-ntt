    ...
    with get_connection() as conn:
        ...
        with conn.cursor() as cur:
            table_columns = {
                ...
                "shipments": {"sales_id": "INTEGER", "service_type": "TEXT", "mother_vessel": "TEXT", "mother_voyage": "TEXT", "feeder_vessel": "TEXT", "feeder_voyage": "TEXT", "financial_locked": "INTEGER DEFAULT 0", "handover_to_accounting_at": "TEXT", "handover_by": "TEXT", "mbl_no": "TEXT", "hbl_no": "TEXT"},
                "invoices": {"approval_status": "TEXT DEFAULT 'Draft'", "service_type": "TEXT", "feeder_vessel": "TEXT", "vessel_voyage": "TEXT", "pol": "TEXT", "pod": "TEXT", "delivery_port": "TEXT", "mbl_mawb_no": "TEXT", "hbl_hawb_no": "TEXT", "master_job_no": "TEXT", "shipment_no": "TEXT", "tax_receipt_no": "TEXT", "csr_report_no": "TEXT", "total_advance": "REAL DEFAULT 0", "less_vat_sub": "REAL DEFAULT 0", "plus_wht_diff": "REAL DEFAULT 0", "amount_no_vat": "REAL DEFAULT 0", "amount_vat": "REAL DEFAULT 0", "vat_7_amount": "REAL DEFAULT 0", "wht_1_amount": "REAL DEFAULT 0", "wht_3_amount": "REAL DEFAULT 0", "diff_amount": "REAL DEFAULT 0", "grand_total": "REAL DEFAULT 0", "net_payable": "REAL DEFAULT 0", "customer_address": "TEXT", "customer_tax_id": "TEXT", "customer_branch": "TEXT"},
                ...
                "bills_of_lading": {
                    ...
                    "by_carrier_2": "TEXT",
                    "iata_code": "TEXT",
                    "agent_account_no": "TEXT",
                    "exporter_account_no": "TEXT",
                    "consignee_account_no": "TEXT",
                    "accounting_info": "TEXT",
                    "declared_value_carriage": "TEXT DEFAULT 'NVD'",
                    "declared_value_customs": "TEXT DEFAULT 'NCV'",
                    "amount_of_insurance": "TEXT DEFAULT 'XXX'",
                    "handling_info": "TEXT",
                    "sci": "TEXT",
                    "chargeable_weight": "REAL DEFAULT 0",
                    "rate_class": "TEXT DEFAULT 'Q'",
                    "commodity_item_no": "TEXT",
                    "rate_charge": "REAL DEFAULT 0",
                    "total_charge": "REAL DEFAULT 0",
                    "weight_charge_ppd": "REAL DEFAULT 0",
                    "weight_charge_coll": "REAL DEFAULT 0",
                    "valuation_charge_ppd": "REAL DEFAULT 0",
                    "valuation_charge_coll": "REAL DEFAULT 0",
                    "tax_ppd": "REAL DEFAULT 0",
                    "tax_coll": "REAL DEFAULT 0",
                    "other_charges_agent_ppd": "REAL DEFAULT 0",
                    "other_charges_agent_coll": "REAL DEFAULT 0",
                    "other_charges_carrier_ppd": "REAL DEFAULT 0",
                    "other_charges_carrier_coll": "REAL DEFAULT 0",
                    "other_charges_desc": "TEXT",
                    "total_prepaid": "REAL DEFAULT 0",
                    "total_collect": "REAL DEFAULT 0",
                    "currency": "TEXT DEFAULT 'USD'",
                    "chgs_code": "TEXT DEFAULT 'PP'",
                    "wt_val_ppd": "TEXT DEFAULT 'P'",
                    "wt_val_coll": "TEXT",
                    "other_ppd": "TEXT DEFAULT 'P'",
                    "other_coll": "TEXT",
                    "truck_waybill_no": "TEXT",
                    "truck_type": "TEXT",
                    "truck_plate": "TEXT",
                    "driver_name": "TEXT",
                    "driver_phone": "TEXT",
                    ...
                    "move_type": "TEXT DEFAULT 'Full Truck Load (FTL)'",
                    "freight_charges": "REAL DEFAULT 0",
                    "duty_other_charges": "REAL DEFAULT 0",
                    "origin_charges": "REAL DEFAULT 0",
                    "destination_charges": "REAL DEFAULT 0",
                },
