...
def ensure_phase30_local_schema() -> None:
    with get_connection() as conn:
        ...
        with conn.cursor() as cur:
            ...
            for ddl in [
                "CREATE TABLE IF NOT EXISTS ap_vouchers (id INTEGER PRIMARY KEY AUTOINCREMENT, tenant_id TEXT DEFAULT 'default', party_id INTEGER, voucher_no TEXT, voucher_type TEXT DEFAULT 'PAYMENT_VOUCHER', job_no TEXT, vendor_id INTEGER, payee_name TEXT, payee_tax_id TEXT, vendor_invoice_refs TEXT, invoice_no TEXT, invoice_date TEXT, due_date TEXT, payment_date TEXT, currency TEXT DEFAULT 'THB', exchange_rate REAL DEFAULT 1, subtotal REAL DEFAULT 0, tax REAL DEFAULT 0, wht_total REAL DEFAULT 0, total REAL DEFAULT 0, status TEXT DEFAULT 'REQUESTED', remark TEXT, created_by TEXT, created_at TEXT DEFAULT CURRENT_TIMESTAMP, updated_at TEXT DEFAULT CURRENT_TIMESTAMP)",
