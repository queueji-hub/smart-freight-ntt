    ...
    with get_connection() as conn:
        ...
        with conn.cursor() as cur:
            table_columns = {
                ...
                "job_costs": {"tenant_id": "TEXT DEFAULT 'default'", "line_no": "INTEGER DEFAULT 1", "unit": "TEXT DEFAULT 'UNIT'", "cost_status": "TEXT DEFAULT 'ESTIMATED'", "billable_to_customer": "INTEGER DEFAULT 1", "matched_charge_code": "TEXT", "vendor_invoice_no": "TEXT", "payout_status": "TEXT DEFAULT 'UNPAID'", "billing_status": "TEXT DEFAULT 'UNBILLED'", "tax_type": "TEXT DEFAULT 'VAT 7%'", "vat_amount": "REAL DEFAULT 0", "wht_type": "TEXT DEFAULT 'None'", "wht_amount": "REAL DEFAULT 0", "net_amount": "REAL DEFAULT 0", "voucher_no": "TEXT", "invoice_no": "TEXT", "matched_ap_id": "INTEGER"},
                "ap_vouchers": {"tenant_id": "TEXT DEFAULT 'default'", "voucher_no": "TEXT", "voucher_type": "TEXT DEFAULT 'PAYMENT_VOUCHER'", "job_no": "TEXT", "vendor_id": "INTEGER", "payee_name": "TEXT", "invoice_no": "TEXT", "invoice_date": "TEXT", "due_date": "TEXT", "payment_date": "TEXT", "currency": "TEXT DEFAULT 'THB'", "exchange_rate": "REAL DEFAULT 1", "subtotal": "REAL DEFAULT 0", "tax": "REAL DEFAULT 0", "wht_total": "REAL DEFAULT 0", "total": "REAL DEFAULT 0", "status": "TEXT DEFAULT 'REQUESTED'", "remark": "TEXT", "created_by": "TEXT"},
            ...
            for ddl in [
                "CREATE TABLE IF NOT EXISTS ap_vouchers (id INTEGER PRIMARY KEY AUTOINCREMENT, tenant_id TEXT DEFAULT 'default', voucher_no TEXT, voucher_type TEXT DEFAULT 'PAYMENT_VOUCHER', job_no TEXT, vendor_id INTEGER, payee_name TEXT, invoice_no TEXT, invoice_date TEXT, due_date TEXT, payment_date TEXT, currency TEXT DEFAULT 'THB', exchange_rate REAL DEFAULT 1, subtotal REAL DEFAULT 0, tax REAL DEFAULT 0, wht_total REAL DEFAULT 0, total REAL DEFAULT 0, status TEXT DEFAULT 'REQUESTED', remark TEXT, created_by TEXT, created_at TEXT DEFAULT CURRENT_TIMESTAMP, updated_at TEXT DEFAULT CURRENT_TIMESTAMP)",
